...
class USPhoneWidget(StringWidget):
    ...
    _properties.update({
        'size' : '20',
        'maxlength' : '20',
	'description':"Enter phone number in the form '(800) 555-1212'. Don't forget the area code.",
        })
...
class AddressWidget(TextAreaWidget):
    ...
    _properties.update({
        'rows'  : 3,
        'cols'  : 40,
	'description' : "Enter the address, putting each address line on a separate line.",
...
__all__ = ( 'LinkWidget', 'USPhoneWidget', 'EmailWidget', 'AddressWidget', 'InstructionWidget', 'SimpleDataGridWidget' )
